...
\begin{equation}
\frac{\rho C_p T_{neb}}{\tau_{1/2}} \partial_{t} T = \frac{\rho C_p T_{neb}}{\tau_{1/2}} \frac{1}{r^2} \partial_{r} ( {r}^2 \partial_{r} T)  + P 
\end{equation}
...
\begin{equation}
\rho C_p (d_{t'} T' - r \frac{\dot{R}}{R}\partial_{r} T')= \frac{1}{r^2} \partial_{r} ( k_{T} \frac{r^2}{R^2} \partial_{r} T')  + P
\end{equation}

\begin{equation}
\frac{\rho C_p T_{neb}}{\tau_{1/2}} \partial_{t} T =  \frac{1}{r^2} \partial_{r} ( T_{neb} k_{T} \frac{r^2}{R^2} \partial_{r} T) + \rho C_p T_{neb} r \frac{\dot{R}}{R}\partial_{r} T + P
\end{equation}

\begin{equation}
T^{t+1} - T^t =  \frac{\tau_{1/2}    k_{T}}{\rho C_p } \frac{\Delta t}{r^2} \partial_{r} ( \frac{r^2}{R^2} \partial_{r} T)  +r \tau_{1/2} \Delta t \frac{\dot{R}}{R}\partial_{r} T + \frac{\tau_{1/2}    \Delta t}{\rho C_p T_{neb} } P
\end{equation}
...
+ \tau_{1/2} \Delta t \frac{ r \dot{R}}{2\Delta r R}\Big [ T^{t+1}_{i-1} - T^{t+1}_{i+1}  \Big] = T^{t}_r  + \frac{\tau_{1/2} \Delta t}{\rho C T_{neb}} P^t_i
\end{multline}
...
\frac{r^2_{i-1/2}}{\Delta r^2 R^2 r^2_i}$
, $c_3 = \tau_{1/2} \Delta t \frac{ r \dot{R}}{2\Delta r R}$
